...
<head>
  ...
  <style>
    ...
    /* Принудительное переопределение инлайн-стилей для .owl-item */
    .owl-carousel .owl-item[style*="height"] {
      height: 500px !important;
      max-height: 500px !important;
      min-height: 500px !important;
    }
    ...
    /* Принудительное переопределение инлайн-стилей для изображений */
    .owl-carousel .owl-item img[style*="height"] {
      height: 500px !important;
      max-height: 500px !important;
      min-height: 500px !important;
      object-fit: cover !important;
    ...
    /* Принудительное переопределение инлайн-стилей для stage */
    .owl-carousel .owl-stage-outer[style*="height"],
    .owl-carousel .owl-stage[style*="height"] {
      height: 500px !important;
      max-height: 500px !important;
      min-height: 500px !important;
    }
      ...
      <div class="_container_4gtrl_1" bis_skin_checked="1">
        <article class="_banner_o6otq_1">
          <div class="owl-carousel owl-theme" id="bannerCarousel">
            <div class="item">
              <img fetchpriority="high" alt="banner" src="./images/giiS5kwt90e3x8IulZtplQG0nQZl3ZaGZ4pYvncg.jpg">
            </div>
            <div class="item">
              <img alt="banner" src="./images/j5Ix3QEjL4KzHzjPOqwI85DoCtjRvjRB8jtSVPO6.jpg">
            </div>
            <div class="item">
              <img alt="banner" src="./images/PTKkXHG9bTaYEwbPsoSKON5ozUn3BJCzrfPfnQiQ.jpg">
            </div>
          </div>
        </article>

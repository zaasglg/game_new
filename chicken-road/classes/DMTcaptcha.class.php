<?php
	...
	class DMTcaptcha{
		...
		function DMTcaptcha(){
			...
			global $use_symbols, $use_symbols_len, $length, $amplitude_min, $amplitude_max, 
				   $font_width, $rand_bsimb_min, $rand_bsimb_max, $margin_left, $margin_top, 
				   $font_size, $jpeg_quality;
			$this->keystring = '';
			for( $i=0; $i<$length; $i++ ){
			...
			$px = $margin_left;
			for( $i = 0; $i<$length; $i++ ){
				imagettftext( $im, $font_size, 0, $px, $margin_top, $font_color, CLASS_DIR ."DMT_captcha_fonts/CARTOON8.TTF", $this->keystring[$i] );
